...
void game::draw()
{
	...
	for (int i = 0; i < _bar2.size(); i++)
	{
		if ((_ball.playerdesRect.x >= _bar2[i].barRect.x - 30) && (_ball.playerdesRect.x <= _bar2[i].barRect.x + 80) && (_ball.playerdesRect.y + 50 >= _bar2[i].barRect.y) && (_ball.playerdesRect.y + 43 <= _bar2[i].barRect.y)) {
